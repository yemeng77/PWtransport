      subroutine input(AL,ilocal,tolug,tolE,mxlow,
...
**************************************************
     ...
     &  write(6,*) "file ***etot.input*** does not exist, stop"
       ...
       read(9,*,iostat=ierr) i1, ivext_in,fvext_in,ivext_dir,
     &                  xvext_c,dv_mix,nite_mix,dv_jump_init
       if(ierr.ne.0) call error_stop(10)
     ...
     &                    iw_i,iw_f,fdens_out
       ...
       read(9,*,iostat=ierr) i1, totNel,mx,mxlow,tolug,tolE
	 ...
	 enddo
       ...
       enddo
       read(9,*,iostat=ierr) i1,ifl_trans,
     &  E1_trans,E2_trans,N_trans,n1w,dV,dE_evan,dk_same
       if(ierr.ne.0) call error_stop(22+ntype)
       close(9)
