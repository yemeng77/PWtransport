...
c Modificado por Txomin
c       call mpi_allreduce(fx,fx,1,MPI_REAL8,
       call mpi_allreduce(fx,fx_rec,1,MPI_REAL8,
     & MPI_SUM,MPI_COMM_WORLD,ierr)
     	fx = fx_rec
c       call mpi_allreduce(fy,fy,1,MPI_REAL8,
       call mpi_allreduce(fy,fy_rec,1,MPI_REAL8,
     & MPI_SUM,MPI_COMM_WORLD,ierr)
     	fy = fy_rec
c       call mpi_allreduce(fz,fz,1,MPI_REAL8,
       call mpi_allreduce(fz,fz_rec,1,MPI_REAL8,
     & MPI_SUM,MPI_COMM_WORLD,ierr)
	fz = fz_rec
