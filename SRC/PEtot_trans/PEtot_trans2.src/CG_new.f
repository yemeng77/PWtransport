...
*****************************
**** option:
**** ivariational=1   do one extra H*psi, just to get variational results. 
*****  so, the E_st(i) is the correct one after orthogonalization
*****
**** ivariational=0   do not do a extra H*psi, Etot might not be variational
****    E_st(i) might not be correct after orthogonalization
****
*****************************************
****  current version, we use ivariational=0 (set as parameter!)
*****************************************
...
*****************************************************
      if(ivariational.eq.1) then     ! cost one extra H*psi step !
      do m=1,mx
       call Hpsi_comp(ug_n(1,m),Rgh(1,1),
     &        ilocal,vr,workr_n,kpt)
       s=0.d0
