...
********************************************
       ...
       real*8,allocatable,dimension(:)  :: v_dv
...
ccccccccccccccccccccccccccccccccccccccccccccc
       ...
       call rhoIO(AL,v_dv,mr_n,2,file_dV)

       do i=1,nr_n
       workr_n(i)=v_dv(i)
       enddo
       call d3fft_comp(wgp_n(1,ii),workr_n,1,kpt)
...
cccccccccc  TEST
       ...
       v_dv(i)=workr_n(i)
       enddo
       file_dV="wr_out."//char(48+ii1)//char(48+ii2)
       call rhoIO(AL,v_dv,mr_n,1,file_dV)
