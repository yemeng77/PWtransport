...
ccccccc For vq and vqT, they scale as 1/q^2 for small q, thus 
ccccccc interpolate vq*q**2, instead of vq itself. 
...
*************************************
      ...
      do iislda=1,islda
      do i=1,nr_n
      rho_n(i,iislda)=rho_n(i,iislda)*s        ! do not use abs(), make it possible for negative rho_n
      enddo
      enddo
