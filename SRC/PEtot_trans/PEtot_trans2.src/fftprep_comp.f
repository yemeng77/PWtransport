...
cc      common /mpi_data/inode,nnodes
...
c      call mpi_allreduce(mgz,mgz,1,mpi_integer,mpi_max,
      call mpi_allreduce(mgz,mgz_rec,1,mpi_integer,mpi_max,
     &                    MPI_COMM_WORLD, ierr)
	mgz = mgz_rec
	call mpi_barrier(MPI_COMM_WORLD,ierr)
