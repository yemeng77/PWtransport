      subroutine mch_kerk(w_in,w_out,amx_mth)
******************************************
...
********** treated carefully.
      ...
      vi(i*2)=((0.8d0*gkk2_nL(i)+amx_mth)/
     &        (gkk2_nL(i)+0.5d0)-0.8d0)*vi(i*2)
      vi(i*2-1)=((0.8d0*gkk2_nL(i)+amx_mth)/
     &        (gkk2_nL(i)+0.5d0)-0.8d0)*vi(i*2-1)
       endif
