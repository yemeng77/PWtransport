...
***** cphase is not installed yet
       ...
       complex*16 wg(mg_nx),wgh(mg_nx),swg(*)
       complex*16 wg_dum(mg_nx)
       complex*16, allocatable, dimension(:) :: workr2_n

       integer nmap(matom)

       complex*16 sumdum(mref,matom),sumdum2(mref),sumdum3(mref)
       complex*16 sumdumtmp(mref,matom)
...
c       write(6,*) "test0", inode_tot

       if(ilocal.eq.3) then     
       call nonlocal_qsp()
       endif    
c       write(6,*) "test8", inode_tot
...
cccccccccccccccccccccccccccccccc
       ...
       real*8 sumy31(mref),sumy32(mref)
...
cccccccccccc most often, sumdum is much smaller than natom*mref !
       call mpi_allreduce(sumdum,sumdumtmp,natom*mref,
...
cccccccccccccccccccccccccccccccccccccc
       ...
       implicit double precision (a-h,o-z)
       complex*16 cc1,cc0,sumy(mref)
       cc1=dcmplx(1.d0,0.d0)
       cc0=dcmplx(0.d0,0.d0)

c       write(6,*) "test1", inode_tot
