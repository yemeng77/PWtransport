      subroutine getpot5_force(rho,vtot,rhocr,xgga)
******************************************
...
c       if(up+dn.lt.rho_max*1.D-3) then    ! special, make it stable
c       vxuppbe=0.d0
c       vcuppbe=0.d0
c       vxdnpbe=0.d0
c       vcdnpbe=0.d0
