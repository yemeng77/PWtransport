...
******************************************
      ...
      real*8,allocatable,dimension(:)     :: vmask_nL
      ...
      real*8,allocatable,dimension(:,:)        :: rho_nLE,rho_nRI
...
c      complex*16,allocatable,dimension(:,:)  :: ug_n,sug_n, ug_n_bp
     ...
     & mr_nL,npulay_max
      ...
      allocate(rho_nLE(mr_n,islda))
      allocate(rho_nRI(mr_n,islda))
