...
c
c     $Id: cfftd.f,v 1.1.1.1 1992/05/08 19:44:48 jimb Exp $
c
c     $Log: cfftd.f,v $
c Revision 1.1.1.1  1992/05/08  19:44:48  jimb
c
c     Revision 1.1  89/03/16  12:46:30  sverre
c     Initial revision
c     
c
...
c
      character rcsid*50
      rcsid = '$RCSfile: cfftd.f,v $$Revision: 1.1.1.1 $'
c
      if (n .eq. 1) return
c
      iw1 = n+n+1
